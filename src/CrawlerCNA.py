...
CrawlerResult = collections.namedtuple('CrawlerResult', ['id', 'url', 'status', 'category', 'text', 'headline', 'outdated'])


class CrawlerCNA:
	url = 'https://www.cna.com.tw/cna2018api/api/WNewsList'
	json = {'action': '0', 'category': 'aall', 'pageidx': 1}
	abbrToCategories={'aall':'即時','aipl':'政治','aopl':'國際','acn':'兩岸','aie':'產經','asc':'證券','ait':'科技','ahel':'生活','asoc':'社會','aloc':'地方','acul':'文化','aspt':'運動','amov':'娛樂'}
	categoriesToAbbr={'即時':'aall','政治':'aipl','國際':'aopl','兩岸':'acn','產經':'aie','證券':'asc','科技':'ait','生活':'ahel','社會':'asoc','地方':'aloc','文化':'acul','運動':'aspt','娛樂':'amov'}
	...
	def get_page(self, id):
		...
		return {'url':url, 'status':status, 'category':category, 'text':text, 'headline':headline, 'outdated':'您所瀏覽的新聞已過查詢時效' in r.text}
